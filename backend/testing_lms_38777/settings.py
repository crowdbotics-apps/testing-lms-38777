"""
Django settings for testing_lms_38777 project.
...
ROOT_URLCONF = 'testing_lms_38777.urls'
...
WSGI_APPLICATION = 'testing_lms_38777.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testing_lms_38777 API",
    "DESCRIPTION": "API documentation for testing_lms_38777 App",
    "VERSION": "v1",
}
